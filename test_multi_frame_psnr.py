...
def test():
    code_name = 'OURS_x4'
    data_mode = 'temp'
    result_folder = './evaluations'
    N_ot = 5     # control the slice number you want to interpolate [1, 3, 5]
    use_time = True
    ...
    # test file path
    dataset_folder = '/home/lpc/dataset/final_test/vessel_volume_img/*'
    # dataset_folder = '/home/lpc/dataset/final_test/LITS_volume_img/*'
    # dataset_folder = '/home/lpc/dataset/final_test/kidney_volume_img/*'
    # dataset_folder = '/home/lpc/dataset/final_test/colon_volume_img/*'
    ...
    for sub_folder in sub_folder_l:
       ...
       # process each image
        for select_idxs in select_idx_list:
            # get input images
            select_idx = [select_idxs[0][0], select_idxs[0][-1]]  #取首位两张图片输入
            gt_idx = select_idxs[1][1:-1]  # 中间图片为gt
